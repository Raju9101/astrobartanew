                  ...
                  <Card key={astrologer.id} className="overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 h-full flex flex-col">
                    <CardContent className="p-4 flex flex-col flex-1">
                        ...
                        <Link href={`/astrologers/${encodeURIComponent(astrologer.name)}`} className="flex items-start gap-3 flex-1 min-w-0">
                          <div className="flex flex-col items-center flex-shrink-0">
                            <div className="relative">
                              ...
                              {astrologer.isOnline && <div className="absolute top-1 right-1 w-4 h-4 bg-green-500 border-2 border-background rounded-full" title="Online"></div>}
                            </div>
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-auto">
                          ...
                          <CallRequestDialog
                            trigger={
                              <Button className="w-full text-foreground border-primary hover:bg-primary/10">

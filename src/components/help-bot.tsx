          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                asChild
                size="icon"
                className="rounded-full w-10 h-10 bg-rose-500 hover:bg-rose-600 text-white shadow-lg"
        ...
        <Tooltip>
            <TooltipTrigger asChild>
                <Button
                    ...
                    size="icon"
                    className="rounded-full w-12 h-12 bg-rose-500 hover:bg-rose-600 text-white shadow-xl transform transition-transform duration-300 hover:scale-110"
                    aria-label={isOpen ? 'Close help menu' : 'Open help menu'}
                >
                    <div className="relative w-full h-full flex items-center justify-center">
                        <Bot className={cn('h-6 w-6 transition-all duration-300', isOpen ? 'rotate-180 opacity-0 scale-0' : 'rotate-0 opacity-100 scale-100')} />
                        <X className={cn('h-6 w-6 absolute transition-all duration-300', isOpen ? 'rotate-0 opacity-100 scale-100' : '-rotate-180 opacity-0 scale-0')} />
                    </div>
                </Button>
            </TooltipTrigger>
             <TooltipContent side="left">
